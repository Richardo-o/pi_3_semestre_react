...
export default function Indicators({ selectedVegetable }) {
  ...
  const getWaterLevel = () => {
    if (
      selectedVegetable &&
      selectedVegetable.nivel &&
      selectedVegetable.nivel.nivel_agua !== null &&
      selectedVegetable.nivel.nivel_agua !== undefined
    ) {
  ...
  const getFertilizerLevel = () => {
    if (
      selectedVegetable &&
      selectedVegetable.nivel &&
      selectedVegetable.nivel.nivel_fertilizante !== null &&
      selectedVegetable.nivel.nivel_fertilizante !== undefined
    ) {
  ...
  return (
    <div className={styles.grid}>
      ...
      <div className={`${styles.card} ${styles.orange}`}>
        ...
        <div className={styles.content}>
          <div className={styles.label}>pH da solução nutritiva</div>
